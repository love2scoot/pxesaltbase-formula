...
saltbase_helper1:
  file.managed:
    ...
    - group: root
    - mode: 755
    - source: http://{{ pillar.get('PXE_DNS_NAME') }}/saltbase_install/enable_ssh.sh
    - skip_verify: true
saltbase_helper2:
  file.managed:
    ...
    - group: root
    - mode: 755
    - source: http://{{ pillar.get('PXE_DNS_NAME') }}/saltbase_install/newsalthostname.sh
    - skip_verify: true
saltbase_helper3:
  file.managed:
    ...
    - group: root
    - mode: 755
    - source: http://{{ pillar.get('PXE_DNS_NAME') }}/saltbase_install/setupnetwork.sh
    - skip_verify: true
...
devops_config_install:
  file.managed:
    ...
    - group: root
    - mode: 644
    - source: http://{{ pillar.get('PXE_DNS_NAME') }}/saltbase_install/devops_standard.conf
    - skip_verify: true
...
gitfs_remotes_template:
  file.managed:
    ...
    - group: root
    - mode: 644
    - source: http://{{ pillar.get('PXE_DNS_NAME') }}/saltbase_install/gitfs_remotes.conf
    - skip_verify: true
